...
public class HibernateConfig {
    ...
    public LocalSessionFactoryBean sessionFactory(){
        ...
        sessionFactory.setPackagesToScan("com.nbu.cscb869_medical_record_system.data");
    ...
    public DataSource dataSource(){
        ...
        dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");dataSource.setUrl(dbUrl);
